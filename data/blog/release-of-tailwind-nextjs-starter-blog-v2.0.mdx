...
In v2, I added a new post layout - `PostBanner`. It features a large banner image and a centered content container. Check out "[Pictures of Canada](/posts/pictures-of-canada)" blog post which has been updated to use the new layout.
