...
var computedFields = {
  readingTime: {
    ...
    resolve: (doc) => {
      ...
      console.log("readingTime:", result);
      return result;
    }
  },
  slug: {
    type: "string",
    resolve: (doc) => {
      const result = doc._raw.flattenedPath.replace(/^.+?(\/)/, "");
  ...
  path: {
    type: "string",
    resolve: (doc) => {
      const result = doc._raw.flattenedPath;
  ...
  filePath: {
    type: "string",
    resolve: (doc) => {
      const result = doc._raw.sourceFilePath;
  ...
  toc: {
    type: "string",
    resolve: (doc) => {
      const result = extractTocHeadings(doc.body.raw);
...
//# sourceMappingURL=compiled-contentlayer-config-XEK6JDLL.mjs.map
